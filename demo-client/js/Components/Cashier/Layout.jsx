...
const navItems = [
    { path: '/cashier/dashboard', label: 'داشبورد', icon: DashboardIcon },
    { path: '/cashier/reservations', label: 'رزروها', icon: ReservationsIcon },
    { path: '/cashier/transactions', label: 'تراکنش‌ها', icon: TransactionsIcon },
    { path: '/cashier/orders', label: 'سفارشات', icon: OrdersIcon },
];
            ...
            <div className="fixed right-0 top-0 h-full w-64 bg-gray-900/95 backdrop-blur-sm border-l border-red-900/50 z-40">
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-6 border-b border-red-900/50">
                        <h1 className="text-2xl font-bold text-white">پنل صندوقدار</h1>
                        {user?.branch && (
                    ...
                    <nav className="flex-1 p-4 space-y-2">
                        {navItems.map((item) => {
                            const isActive = location.pathname === item.path || 
                                (item.path !== '/cashier/dashboard' && location.pathname.startsWith(item.path));
                    ...
                    <div className="p-4 border-t border-red-900/50">
                        <div className="mb-3">
                            <p className="text-sm text-gray-400">صندوقدار</p>
