...
function Layout() {
    ...
    const getPageTitle = () => {
        ...
        if (pathname === '/menu') return 'منوی کافه';
        if (pathname === '/my-sessions') return 'سانس‌های من';
        if (pathname === '/book') return 'رزرو وقت';
        if (pathname.startsWith('/book/session/')) return 'رزرو سانس';
