...
class TestDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Create Sessions (some from templates, some one-time)
        $today = Carbon::today();
        
        // Monday sessions
        $monday1 = Session::create([
            'branch_id' => $branch1->id,
            'hall_id' => $hall1->id,
            'session_template_id' => $template1->id,
            'date' => $today->copy()->next(Carbon::MONDAY)->format('Y-m-d'),
            'start_time' => '18:00:00',
            'price' => 50000,
            'max_participants' => 10,
        ...
        // Wednesday session
        $wednesday = Session::create([
            'branch_id' => $branch1->id,
            'hall_id' => $hall1->id,
            'session_template_id' => $template3->id,
            'date' => $today->copy()->next(Carbon::WEDNESDAY)->format('Y-m-d'),
            'start_time' => '19:00:00',
            'price' => 55000,
            'max_participants' => 10,
            'current_participants' => 0,
        ...
        $friday = Session::create([
            'branch_id' => $branch1->id,
            'hall_id' => $hall2->id,
            'session_template_id' => $template4->id,
            'date' => $today->copy()->next(Carbon::FRIDAY)->format('Y-m-d'),
            'start_time' => '20:00:00',
            'price' => 80000,
            'max_participants' => 8,
            'current_participants' => 0,
        ...
        // Update reservations with payment transaction IDs
